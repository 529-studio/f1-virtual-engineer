...
function CrossYearPreview() {
  const path24 =
    "M0,38 C30,32 60,40 100,28 140,18 180,30 220,22 260,12 300,28 340,20 380,14 400,18 420,22";
  const path23 =
    "M0,52 C30,46 60,54 100,42 140,32 180,44 220,38 260,28 300,42 340,34 380,28 400,32 420,38";
